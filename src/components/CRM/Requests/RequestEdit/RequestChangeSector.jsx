...
const RequestChangeSector = (props) => {
        ...
        <div className={`mb-1 ${!row.sector ? "text-danger" : ""}`}>
            ...
            >
                <Dropdown.Menu>
                    ...
                    {data?.callcenters && data?.callcenters.length &&
                        <>
...
export default RequestChangeSector;
